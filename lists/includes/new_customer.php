    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">New Customer</h5>
            ...
            <form id="form_new_record" action="#" method="post">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-3 mb-3">
                            <label for="countryBasic" class="form-label">Country</label>
                            <input type="text" id="countryBasic" class="form-control" placeholder="Country" name="country">
                            <div class="error-message"></div>
                        </div>
                        ...
                        <div class="col-3 mb-0">
                            ...
                            <select id="companyBasic" class="form-control" name="company_id">
                                <?php 
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 mb-0">
                            ...
                            <input type="text" id="urlBasic" class="form-control" placeholder="www.xxx.xxx" name="url">
                            <div class="error-message"></div>
                        </div>
                    </div>
                </div>
