    ...
    <div class='table-Wrapper' style="flex: 1 1 auto; margin:15px 0 0 0; overflow:hidden;">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" type="button" role="tab">PlaceHOlder</button>
            </li>
        </ul>
    </div>

    <!-- <div class="card" style="flex: 1 1 auto; margin:15px 0 0 0; overflow:hidden;"> -->
        <!-- <div class="card-body"style="overflow:hidden;padding:0"> -->
            <!-- <div class="card-datatable table-responsive pt-0 d-flex flex-column"style="height:100%;overflow:hidden " id="testidtest">
                <div class="d-flex">
