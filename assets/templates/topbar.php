<div class="container-xxl align-items-center bg-navbar-theme">
    <nav class="container-xxl align-items-center bg-navbar-theme" id="layout-navbar">
        ...
        <div class="navbar-nav-right d-flex align-items-center" >
            ...
            <ul class='navbar-nav flex-row align-items-center ms-auto'>
                ...
                <li class="nav-item me-2 ">
                    <a id='mode-toggle' class="nav-link style-switcher-toggle hide-arrow d-flex" href="javascript:void(0);">
                ...
                <!-- <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 ">
                    <a class="nav-link dropdown-toggle hide-arrow d-flex" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end py-0 notifications-dropdown-menu">
                    ...
                    <li class="dropdown-notifications-list scrollable-container ps">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                <img style='width:54px'src="" alt="" class="w-px-40 h-auto rounded-circle">
                                </div>
                            </div>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow d-flex" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="avatar avatar-online">
                            <img style="width:32px" src="<?=''//isset($_SESSION['user']['picture'])&&$_SESSION['user']['picture']?>" alt="" 
                    ...
                    <li>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?=';'//isset($_SESSION['user']['full_name'])&&$_SESSION['user']['full_name']?></span>
                    ...
                    <li>
                        <a class="dropdown-item" href="../settings/profile.php#user_settings" id='user_settings_btn'>
